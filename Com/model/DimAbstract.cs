...
namespace Com.model
{
    ...
    public class DimAbstract
    {
        ...
        /// Greater (output) set.
        /// </summary>
        private Concept _greaterSet;
        public Concept GreaterSet
        {
        ...
        /// Lesser (input) set. 
        /// </summary>
        private Concept _lesserSet;
        public Concept LesserSet
        {
        ...
        // Memory management parameters for instances (used by extensions).
...
//        private String sorting;
        ...
        public DimAbstract(string name)
            : this(name, null, null)
        {
        }

        public DimAbstract(string name, Concept lesserSet, Concept greaterSet)
            : this(name, lesserSet, greaterSet, false, false, true)
        {
        }

        public DimAbstract(string name, Concept lesserSet, Concept greaterSet, bool isIdentity, bool isReversed, bool isInstantiable)
        {
            _id = uniqueId++;
            _name = name;
